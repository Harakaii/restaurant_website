...
<div class="col-md-4  card text-white bg-success mb-3" style="max-width: 18rem; ">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover table-bordered table-responsive">
                            ...
                            <tr>
                                ...
                                <td>{{ $dish->name }}</td>
                                <td>
                                    <img src="{{ asset($dish->attributes->image) }}" style="width: 50px; height: 50px; border-radius: 50%">
                                </td>
 ...
 -->
                                @if(Session::has('coupon'))
                                        ...
                                        <td>
                                        {{ $dish->quantity }}
                                            <!-- <input type="number" name="quantity" value="{{ $dish->quantity }}" style="width: 50px; height:25px" minlength="1"> -->
                                        ...
                                        <td>
                                            ...
                                            ( - {{$discount = $subTotal * session()->get('coupon')['coupon_value'] / 100 }}$)
                                        ...
                                        <td>
                                            <input type="hidden" value="{{ $total= $dish->price*$dish->quantity }}">
                                ...
                                @else
                                    ...
                                    <td class="form-inline">{{ $subTotal= $dish->price*$dish->quantity }} $</td>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/register/customer" data-toggle="modal" class="btn-block btn-primary text-center"
                                   style="
                                            height: 60px;
                                            width: auto;
                                            padding-top: 12px;
                                ...
                                <a href="/login/customer/" data-toggle="modal" class="btn-block btn-success text-center"
                                   style="
                                            height: 60px;
                                            width: auto;
                                            padding-top: 12px;
