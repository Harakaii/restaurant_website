...
@section('content')
	...
	<div class="login-page about">
		...
		<div class="container">
            ...
            <form action="{{route('store_shipping')}}" method="post" enctype="multipart/form-data">
                @csrf
                <label for="">Full Name</label>
                    <input class="agile-ltext" type="text" name="name" placeholder="Username" required="" value="{{$customer->name}}">
